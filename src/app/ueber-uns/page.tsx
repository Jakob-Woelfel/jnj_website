...
export const metadata: Metadata = {
  title: 'Über uns',
  description: 'Zwei Jakobs, ein Ziel. Wir haben J&J Studios gegründet, weil gute kleine Unternehmen bessere Websites verdienen.',
};
  ...
  return (
    <div>
      <Section pad="clamp(48px, 6vw, 80px)">
        <div className="jj-hero-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1fr)', gap: 'clamp(32px, 5vw, 72px)', alignItems: 'center' }}>
          <div>
