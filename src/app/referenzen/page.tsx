...
export const metadata: Metadata = {
  title: 'Referenzen',
  description: 'Echte Websites für echte Unternehmen. Sehen Sie, wie wir Zahnarztpraxen, Cafés und Handwerksbetriebe online gebracht haben.',
};

const CASES = [
  { tag: 'Zahnarztpraxis', title: 'Zahnarztpraxis Alvarez', blurb: 'Eine veraltete, schwer lesbare Website wurde zu einer ruhigen, modernen mit Online-Terminbuchung im Mittelpunkt.', result: 'Neupatientenanfragen verdoppelt im ersten Monat.', icon: 'sparkles' as const, tone: 'green' as const },
  { tag: 'Café',           title: 'Café am Marktplatz',     blurb: 'Eine klare Speisekarte und ein gut sichtbarer "Reservieren"-Button verwandelten Suchende in Gäste und Wochenend-Buchungen.',  result: 'Wochenend-Buchungen um 60 % gestiegen.',            icon: 'heart'     as const, tone: 'gold'  as const },
  { tag: 'Dachdeckerei',   title: 'Becker & Söhne Dach',    blurb: 'Eine vertrauenswürdige, bildstarke Website mit Anfrageformular machte es leicht, sie den großen Ketten vorzuziehen.',          result: 'Über 30 Angebotsanfragen pro Monat.',               icon: 'shieldCheck' as const, tone: 'green' as const },
];
  ...
  return (
    <div>
      <Section pad="clamp(48px, 6vw, 72px)">
        <SectionHeading align="left" eyebrow="Unsere Referenzen" title="Echte Websites, für echte Unternehmen" lead="Kein Blendwerk. Wir bauen Websites, die zu Ihnen passen und leise Ergebnisse liefern. Hier sind ein paar Beispiele." />
      </Section>
