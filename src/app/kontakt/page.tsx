          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '18px', marginTop: '34px' }}>
              {REASSURANCES.map((r) => (
                <div key={r.title} style={{ display: 'flex', gap: '14px' }}>
                  <span style={{ width: '44px', height: '44px', flex: 'none', borderRadius: 'var(--radius-md)', background: 'var(--green-50)', color: 'var(--green-700)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ marginTop: '34px', paddingTop: '26px', borderTop: '1px solid var(--border-default)', display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '9px', fontSize: '15.5px', color: 'var(--text-body)' }}>
                <Icon name="mail" size={18} style={{ color: 'var(--green-600)' }} /> hallo@jj-studios.de
              </span>
              <span style={{ display: 'inline-flex', alignItems: 'center', gap: '9px', fontSize: '15.5px', color: 'var(--text-body)' }}>
                <Icon name="phone" size={18} style={{ color: 'var(--green-600)' }} /> +49 (0) XXX XXXXXXX
              </span>
            </div>
          </div>
          ...
          <Card padding="lg" style={{ boxShadow: 'var(--shadow-md)' }}>
            {sent ? (
              <div style={{ textAlign: 'center', padding: '40px 10px' }}>
                <span style={{ width: '64px', height: '64px', borderRadius: '50%', background: 'var(--green-50)', color: 'var(--green-600)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
